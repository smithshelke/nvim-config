...
vim.keymap.set('n', '<leader>ve', require('telescope.builtin').diagnostics, { desc = '[S]earch [D]iagnostics' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>vd', vim.lsp.buf.definition, '[G]oto [D]efinition')
  nmap('<leader>vr', require('telescope.builtin').lsp_references, '[G]oto [R]eferences')
  nmap('<leader>vi', vim.lsp.buf.implementation, '[G]oto [I]mplementation')
